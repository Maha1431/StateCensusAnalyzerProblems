...
namespace StateCensusTest
{
    public class Tests
    {
        ...
        string wrongFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\StateCensusData.csv";
        string typeWrongFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\StateCensusData.txt";
        string headerFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\StateCensusDataInvalid.csv";

        string StateFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\StateCode.csv";
        string wrongStateFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\StateCode.csv";
        string typeWrongStateFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\StateCode.txt";
        string headerStateFilePath = @"C:\Users\CSC\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\StateCodeInvalidHeader.csv";
